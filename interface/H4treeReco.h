...
class H4treeReco : public H4tree
{
 ...
 private:
  ...
  Float_t charge_integ_max_[100], charge_integ_fix_[100], charge_integ_max30_[100], charge_integ_max50_[100], charge_integ_[100], charge_integ_smallw_[100] , charge_integ_smallw_mcp_[100] , charge_integ_smallw_noise_[100];
