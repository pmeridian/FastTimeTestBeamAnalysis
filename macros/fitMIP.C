{
  ...
  TFile *_file0 = TFile::Open("/tmp/meridian/RECO_3369.root");
  H4treeReco->Draw("charge_integ_smallw_mcp[3]>>pedestal(250,-200,200)","wc_xl_hits[0]==0 && wc_xr_hits[0]==0 && wc_xl_hits[1]==0 && wc_xr_hits[1]==0 && wc_yu_hits[1]==0 && wc_yd_hits[1]==0 && abs(t_max[1]-60)<10");
  TH1F* pedestal=(TH1F*)gROOT->FindObject("pedestal");
  pedestal->Fit("gaus");
  c1->SaveAs("noise.png");
  H4treeReco->Draw(Form("charge_integ_smallw_mcp[3]-%4.1f>>noise_corrected(250,-200,200)",pedestal->GetFunction("gaus")->GetParameter(1)),"wc_xl_hits[0]==0 && wc_xr_hits[0]==0 && wc_xl_hits[1]==0 && wc_xr_hits[1]==0 && wc_yu_hits[1]==0 && wc_yd_hits[1]==0 && abs(t_max[1]-60)<10");
  TH1F* noise_corrected=(TH1F*)gROOT->FindObject("noise_corrected");
  noise_corrected->Fit("gaus");
  c1->SaveAs("noise_corrected.png");
  H4treeReco->Draw(Form("charge_integ_smallw_mcp[2]-%4.1f>>signal1(80,-200,1000)",pedestal->GetFunction("gaus")->GetParameter(1)),"wave_max[1]>200 && abs(t_max[3]-t_max[1]+5.7)<1. && wave_max[3]>10 && wave_max[3]<200"); 
  H4treeReco->Draw(Form("charge_integ_smallw_mcp[3]-%4.1f>>signal2(80,-200,1000)",pedestal->GetFunction("gaus")->GetParameter(1)),"wave_max[1]>200 && abs(t_max[2]-t_max[1]+5.7)<1. && wave_max[2]>10 && wave_max[2]<200"); 
  ...
  fitFunc->SetParLimits(4,100,3000);
  ...
  c1->SaveAs("MIP_200mu_3369_Total_Ele50.png");
}
